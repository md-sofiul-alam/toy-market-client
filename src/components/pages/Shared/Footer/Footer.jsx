        ...
        <>
            <div className="bg-zinc-500 text-white">
                <footer className="footer p-10 text-base-content">
                    ...
                    <div>
                        <span className="footer-title text-white font-semibold">Category</span>
                    ...
                    <div>
                        <span className="footer-title text-white font-semibold">Social Links</span>
                ...
                <div className="text-center p-5 bg-emerald-200 text-blue-600 font-medium">
                    <small>&copy; {new Date().getFullYear()} - All right reserved by Your Toy</small>
                </div>
            </div>
        </>
    );
